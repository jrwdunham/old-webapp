...
The OLD 0.2.X requires Python 2.5 and Pylons 0.9.7. A local install
for development purposes should probably be created in an isolated
...
v. 0.2.X (using an isolated Python environment, if desired):
